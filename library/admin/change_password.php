            ...
            <?php 
              ...
              if(isset($_POST['submit'])){
                ...
                if(empty($_POST['c_Password'])|| empty($_POST['n_Password'])  || empty($_POST['cn_Password'])){
                  header("location: change_password.php?sign_in=Invalid_pwd");
                  exit();
                }else{
                  ...
                  if($hased_pwd==true){
                    ...
                    if($stmt){
                      ...
                      header("location: change_password.php?sign_in=sucess");
                    }else{
                      header("location: change_password.php?sign_in=Error");
                      exit();
                    }
                  }else{
                    header("location: change_password.php?sign_in=Invalid_pwd");
